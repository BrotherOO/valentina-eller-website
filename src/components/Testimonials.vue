          ...
          >
           <Transition name="fade" mode="out-in">
             <div :key="currentIndex" class="w-full">
                <div class="bg-white p-8 md:p-12 rounded-3xl shadow-lg relative mx-4 md:mx-0 text-center">
                     <!-- Quote Icon -->
                     ...
                     <!-- Stars -->
                     <div class="flex justify-center gap-1 mb-6 text-yellow-400 mt-4">
                     ...
                     <p class="text-lg md:text-2xl text-gray-700 italic mb-8 leading-relaxed max-w-2xl mx-auto">
