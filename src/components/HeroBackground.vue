<template>
  <div ref="containerRef" class="absolute inset-0 -z-10 overflow-hidden bg-transparent">
    ...
    <div class="absolute bottom-0 left-0 w-full h-64 bg-gradient-to-t from-white/95 via-white/40 to-transparent pointer-events-none z-10"></div>
  </div>
</template>
...
const initSilk = () => {
  ...
  const resize = () => {
    ...
    // Fix for 0 height in some flex containers
